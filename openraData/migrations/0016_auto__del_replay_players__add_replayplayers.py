...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReplayPlayers'
        db.create_table(u'openraData_replayplayers', (
        ...
        db.send_create_signal(u'openraData', ['ReplayPlayers'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ReplayPlayers'
        db.delete_table(u'openraData_replayplayers')
