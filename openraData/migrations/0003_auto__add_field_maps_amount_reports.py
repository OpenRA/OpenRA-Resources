...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Maps.amount_reports'
        db.add_column(u'openraData_maps', 'amount_reports',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Maps.amount_reports'
        db.delete_column(u'openraData_maps', 'amount_reports')
