...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Replays.title'
        db.delete_column(u'openraData_replays', 'title')

        # Deleting field 'Replays.posted'
        db.delete_column(u'openraData_replays', 'posted')

        # Adding field 'Replays.metadata'
        db.add_column(u'openraData_replays', 'metadata',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100000),
                      keep_default=False)

        # Adding field 'Replays.parser'
        db.add_column(u'openraData_replays', 'parser',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Replays.version'
        raise RuntimeError("Cannot reverse this migration. 'Replays.version' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Replays.version'
        db.add_column(u'openraData_replays', 'version',
                      self.gf('django.db.models.fields.CharField')(max_length=50),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Replays.title'
        raise RuntimeError("Cannot reverse this migration. 'Replays.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Replays.title'
        db.add_column(u'openraData_replays', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=200),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Replays.posted'
        raise RuntimeError("Cannot reverse this migration. 'Replays.posted' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Replays.posted'
        db.add_column(u'openraData_replays', 'posted',
                      self.gf('django.db.models.fields.DateTimeField')(),
                      keep_default=False)

        # Deleting field 'Replays.metadata'
        db.delete_column(u'openraData_replays', 'metadata')

        # Deleting field 'Replays.parser'
        db.delete_column(u'openraData_replays', 'parser')
