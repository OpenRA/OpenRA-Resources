...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table(u'openraData_rating', (
        ...
        db.send_create_signal(u'openraData', ['Rating'])

        # Deleting field 'Units.rating_votes'
        db.delete_column(u'openraData_units', 'rating_votes')

        # Deleting field 'Units.rating_score'
        db.delete_column(u'openraData_units', 'rating_score')

        # Adding field 'Units.rating'
        db.add_column(u'openraData_units', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Palettes.rating'
        db.add_column(u'openraData_palettes', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Replays.rating'
        db.add_column(u'openraData_replays', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'Mods.rating_votes'
        db.delete_column(u'openraData_mods', 'rating_votes')

        # Deleting field 'Mods.rating_score'
        db.delete_column(u'openraData_mods', 'rating_score')

        # Adding field 'Mods.rating'
        db.add_column(u'openraData_mods', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'openraData_rating')

        # Adding field 'Units.rating_votes'
        db.add_column(u'openraData_units', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Units.rating_score'
        db.add_column(u'openraData_units', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'Units.rating'
        db.delete_column(u'openraData_units', 'rating')

        # Deleting field 'Palettes.rating'
        db.delete_column(u'openraData_palettes', 'rating')

        # Deleting field 'Replays.rating'
        db.delete_column(u'openraData_replays', 'rating')

        # Adding field 'Mods.rating_votes'
        db.add_column(u'openraData_mods', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Mods.rating_score'
        db.add_column(u'openraData_mods', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'Mods.rating'
        db.delete_column(u'openraData_mods', 'rating')
