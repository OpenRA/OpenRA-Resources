...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lints.lint_output'
        db.alter_column(u'openraData_lints', 'lint_output', self.gf('django.db.models.fields.CharField')(max_length=1000000))

    def backwards(self, orm):

        # Changing field 'Lints.lint_output'
        db.alter_column(u'openraData_lints', 'lint_output', self.gf('django.db.models.fields.CharField')(max_length=100000))
