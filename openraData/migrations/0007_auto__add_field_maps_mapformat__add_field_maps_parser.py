...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Maps.mapformat'
        db.add_column(u'openraData_maps', 'mapformat',
                      self.gf('django.db.models.fields.IntegerField')(default=6),
                      keep_default=False)

        # Adding field 'Maps.parser'
        db.add_column(u'openraData_maps', 'parser',
                      self.gf('django.db.models.fields.CharField')(default='release-20141029', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Maps.mapformat'
        db.delete_column(u'openraData_maps', 'mapformat')

        # Deleting field 'Maps.parser'
        db.delete_column(u'openraData_maps', 'parser')
