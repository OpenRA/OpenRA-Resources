...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Replay_Players'
        db.create_table(u'openraData_replay_players', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('replay_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('client_index', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('color', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('faction_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('faction_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('is_bot', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_human', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_random_faction', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_random_spawn', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('outcome', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('outcome_timestamp', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('spawn_point', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'openraData', ['Replay_Players'])

        # Adding field 'Replays.map_hash'
        db.add_column(u'openraData_replays', 'map_hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Replays.version'
        db.add_column(u'openraData_replays', 'version',
                      self.gf('django.db.models.fields.CharField')(default='release-20141029', max_length=100),
                      keep_default=False)

        # Adding field 'Replays.start_time'
        db.add_column(u'openraData_replays', 'start_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Replays.end_time'
        db.add_column(u'openraData_replays', 'end_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Replay_Players'
        db.delete_table(u'openraData_replay_players')

        # Deleting field 'Replays.map_hash'
        db.delete_column(u'openraData_replays', 'map_hash')

        # Deleting field 'Replays.version'
        db.delete_column(u'openraData_replays', 'version')

        # Deleting field 'Replays.start_time'
        db.delete_column(u'openraData_replays', 'start_time')

        # Deleting field 'Replays.end_time'
        db.delete_column(u'openraData_replays', 'end_time')
    ...
    models = {
        ...
        u'openraData.replay_players': {
            'Meta': {'object_name': 'Replay_Players'},
