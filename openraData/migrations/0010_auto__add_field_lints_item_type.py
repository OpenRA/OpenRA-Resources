...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lints.item_type'
        db.add_column(u'openraData_lints', 'item_type',
                      self.gf('django.db.models.fields.CharField')(default='maps', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lints.item_type'
        db.delete_column(u'openraData_lints', 'item_type')
