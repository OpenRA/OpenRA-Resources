...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Maps.rating_score'
        db.delete_column(u'openraData_maps', 'rating_score')

        # Deleting field 'Maps.rating_votes'
        db.delete_column(u'openraData_maps', 'rating_votes')

        # Adding field 'Maps.rating'
        db.add_column(u'openraData_maps', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Maps.rating_score'
        db.add_column(u'openraData_maps', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Maps.rating_votes'
        db.add_column(u'openraData_maps', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'Maps.rating'
        db.delete_column(u'openraData_maps', 'rating')
