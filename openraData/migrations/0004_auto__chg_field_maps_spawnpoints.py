...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Maps.spawnpoints'
        db.alter_column(u'openraData_maps', 'spawnpoints', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Maps.spawnpoints'
        db.alter_column(u'openraData_maps', 'spawnpoints', self.gf('django.db.models.fields.CharField')(max_length=200))
