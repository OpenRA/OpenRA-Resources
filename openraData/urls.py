...
urlpatterns = patterns('',
    ...
    url(r'^maps/author/(?P<author>[\w\ \d]+)/?$', views.mapsFromAuthor, name='mapsFromAuthor'),
    url(r'^maps/author/(?P<author>[\w\ \d]+)/page/(?P<page>\d+)/?$', views.mapsFromAuthor, name='mapsFromAuthor'),
