...
class Command(BaseCommand):
    ...
    def SyncMapsWithRsyncDirs(self):
        # this function syncs rsync directories with fresh list of maps,
        # triggered by uploading a new map or removing one
        ...
        # for duplicates, fetching distinct by hash map,
        # it behaves unpredictably and can remove one and then put another
        removed = ""
